...
const Sidebar = ({ showSidebar, setShowSidebar,closeSidebar }: Props) => {
  return (
    <div ref={closeSidebar} className={`z-50 fixed duration-300 rounded-r-lg drop-shadow-xl -left-[300px] h-full w-[250px] bg-cyan-950 p-2 ${showSidebar && "left-0 duration-300"}`}>
      <h1 className='pl-1 flex items-center text-xl font-semibold capitalize text-red-600 h-[55px]'>parada 18</h1>
