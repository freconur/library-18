...
const UpdateProduct = () => {
  ...
  const [item, setItem] = useState<ProductToCart>(
    {
      description: "",
      stock: "",
      price: "",
  ...
  console.log('LibraryData', LibraryData.brands)
  console.log('LibraryData', LibraryData.category)
  ...
  return (
    <div className='w-full p-2'>
      <div className='bg-white rounded-lg drop-shadow-md p-2'>
        ...
        <input onChange={onChangeCodeValue} ref={focusRef} onKeyDown={testEnter} className={styles.inputCode} type="text" name="code" placeholder='ingresa un codigo' />
      </div>
      <div>
        {loaderChargerStock
          ?
          ...
          <div className='bg-white drop-shadow-lg my-4 p-2 rounded-lg'>
            {item?.description
              ...
              <>
                ...
                {/* <input onChange={onChangeItem} name="brand" className={styles.inputCode} type="text" value={item?.brand} /> */}
                <label className='text-slate-500 font-semibold capitalize '>
                  categoria :
                </label>
                <div className='w-full flex gap-4 justify-center items-center'>
                ...
                <button className='bg-gradient-to-l from-blue-500 to-blue-400 w-full h-[40px] rounded-lg shadow-lg mt-3 text-slate-700 font-semibold capitalize'>actualizar producto</button>
              </>
            }
