...
const Stock = () => {
  ...
  // const handleNext = () => {
  //   nextButtonFilterByStock(firstVisible,lastVisible, paramsFilter)
  // }
  // const handlePreview = () => {
  //   previewButtonFilterByStock(firstVisible,lastVisible, paramsFilter)
  // }
  console.log('currentPage', paginationProducts())
  ...
  return (
    <div className='w-full'>
      ...
      <div className='w-full p-2'>
        ...
        <TableStock productsFromFilterByStock={productsFromFilterByStock} paginationProducts={paginationProducts} />
      </div>
